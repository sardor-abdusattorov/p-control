...
return [
    ...
    'file_viewer' => [
        ...
        'loading_image' => 'Rasm yuklanmoqda...',
        'loading_document' => 'Hujjat yuklanmoqda...',
        'loading_spreadsheet' => 'Jadval yuklanmoqda...',
        'loading_file' => 'Fayl yuklanmoqda',
        'error_loading_pdf' => 'PDF hujjatni yuklashda xatolik',
        'error_loading_image' => 'Rasmni yuklashda xatolik',
        'error_loading_document' => 'Hujjatni yuklashda xatolik',
        'error_loading_file' => 'Faylni yuklashda xatolik',
        'file' => 'Fayl',
        'zoom_in' => 'Kattalashtirish',
        'zoom_out' => 'Kichiklashtirish',
        'reset_zoom' => 'Masshtabni tiklash',
        'fullscreen_enter' => 'To\'liq ekran rejimi',
        'fullscreen_exit' => 'To\'liq ekran rejimidan chiqish',
        'page_of' => ':current-sahifa :total-dan',
        'old_format_not_supported' => 'Eski fayl formati qo\'llab-quvvatlanmaydi',
        'old_word_format_info' => 'Oldindan ko\'rish faqat <strong>.docx</strong> fayllari uchun mavjud<br>Bu fayl eski <strong>.doc</strong> formatiga ega',
        'old_excel_format_info' => 'Oldindan ko\'rish faqat <strong>.xlsx</strong> fayllari uchun mavjud<br>Bu fayl eski <strong>.xls</strong> formatiga ega',
        'download_or_convert' => 'Iltimos, faylni yuklab oling yoki yangi formatga o\'giring',
        'download_file' => 'Faylni yuklab olish',
        'preview_not_available' => 'Oldindan ko\'rish mavjud emas',
        'preview_not_supported' => 'Ushbu turdagi fayllar uchun oldindan ko\'rish qo\'llab-quvvatlanmaydi.',
    ],
];
