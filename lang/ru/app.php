...
return [
    ...
    'label' => [
        ...
        'preserve_approved_status' => 'Сохранить статус «Одобрено»',
        'preserve_approved_status_hint' => 'Контракт уже одобрен. Отметьте, чтобы внести правки без сброса статуса и повторного согласования. Если оставить пустым — заявка вернётся в статус «Новый» и пойдёт на повторное согласование.',
        ...
        'active' => 'Активный',
        'inactive' => 'Неактивный',
        'recent' => 'Недавние элементы',
        'no_products' => 'Продукты не назначены',
        'widgets' => 'Виджеты',
        'no_widgets' => 'Виджеты недоступны',
