        ...
        <div class="space-y-4">
            <div class="px-0">
                <div class="rounded-lg overflow-hidden w-fit">
                    <div>
                        <CreateLink :href="route('contacts.create')" v-show="can(['manage contacts'])"/>
                    </div>
                    <Delete
                ...
                <div class="overflow-x-auto scrollbar-table">
                    <table class="w-full select-width">
                        ...
                        <tr class="dark:bg-slate-900/50 text-left border-b border-slate-300 dark:border-slate-600">
                            ...
                            <th class="px-2 py-4 cursor-pointer w-40" v-on:click="order('firstname')">
                                <div class="flex justify-between items-center">
                                    <span>{{ lang().label.firstname }}</span>
                                    <ChevronUpDownIcon class="w-4 h-4" />
                                </div>
                            </th>
                            <th class="px-2 py-4 cursor-pointer w-40" v-on:click="order('lastname')">
                                <div class="flex justify-between items-center">
                                    <span>{{ lang().label.lastname }}</span>
                                    <ChevronUpDownIcon class="w-4 h-4" />
                                </div>
                            </th>
                            <th class="px-2 py-4 cursor-pointer w-40" v-on:click="order('company')">
                                <div class="flex justify-between items-center">
                                    <span>{{ lang().label.company }}</span>
                                    <ChevronUpDownIcon class="w-4 h-4" />
                                </div>
                            </th>
                            <th class="px-2 py-4 cursor-pointer w-28" v-on:click="order('country')">
                                <div class="flex justify-between items-center">
