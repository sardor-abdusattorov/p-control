                                ...
                                <form @submit.prevent="generateDocx">
                                    <div class="my-6 space-y-4">
                                        <div class="form-group mb-3">
                                            <InputLabel for="docxNumber" :value="lang().label.number" />
                                            <InputText
                                                id="docxNumber"
                                                v-model="form.docxNumber"
                                                class="w-full"
                                                required
                                            />
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            <InputLabel for="docxDate" :value="lang().label.date" />
                                            <InputText
                                                id="docxDate"
                                                type="date"
                                                v-model="form.docxDate"
                                                class="w-full"
                                                required
                                            />
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            <InputLabel for="docxManager" :value="lang().label.manager" />
                                            <InputText
                                                id="docxManager"
                                                v-model="form.docxManager"
                                                class="w-full"
                                                required
                                            />
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            <InputLabel for="docxProject" :value="lang().label.project" />
                                            <InputText
                                                id="docxProject"
                                                v-model="form.docxProject"
                                                class="w-full"
                                                required
                                            />
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            <InputLabel for="docxDetails" :value="lang().label.details" />
                                            <textarea
                                                id="docxDetails"
                                                v-model="form.docxDetails"
