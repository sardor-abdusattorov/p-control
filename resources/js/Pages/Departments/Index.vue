...
import DeleteBulk from "@/Pages/Departments/DeleteBulk.vue";
...
const selectAll = (event) => {
    if (event.target.checked === false) {
        ...
        props.departments.data.forEach((department) => {
            data.selectedId.push(department.id);
        });
    }
};

const select = () => {
    data.multipleSelect = props.department.data.length === data.selectedId.length;
};

const getHeadOfDepartmentName = (headOfDepartmentId) => {
    const user = props.users.find(user => user.id === headOfDepartmentId);
        ...
        <div class="space-y-4">
            <div class="px-4 sm:px-0">
                <div class="rounded-lg overflow-hidden w-fit">
                    <div>
                        <CreateLink :href="route('departments.create')"/>
                    </div>
                    <Delete
            ...
            <div class="relative bg-white dark:bg-slate-800 shadow sm:rounded-lg">
                ...
                <div class="overflow-x-auto scrollbar-table">
                    <table class="w-full">
                        ...
                        <tr class="dark:bg-slate-900/50 text-left">
                            ...
                            <th class="px-2 py-4 cursor-pointer" @click="order('head_of_department')">
                                <div class="flex justify-between items-center">
                                    <span>{{ lang().label.head_of_department }}</span>
                                    <ChevronUpDownIcon class="w-4 h-4"/>
                                </div>
                            </th>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap py-4 px-2">
                                {{ getHeadOfDepartmentName(department.head_of_department) }}
                            </td>
                            <td class="whitespace-nowrap py-4 px-2 sm:py-3">
                ...
                <div class="flex justify-between items-center p-2 border-t border-slate-200 dark:border-slate-700">
                    <Pagination :links="props.departments" :filters="data.params"/>
