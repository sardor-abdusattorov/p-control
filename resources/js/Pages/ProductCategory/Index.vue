...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("product_categories.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
...
const select = () => {
    data.multipleSelect = props.category.data.length === data.selectedId.length;
};
        ...
        <div class="space-y-4">
            <div class="px-4 sm:px-0">
                <div class="rounded-lg overflow-hidden w-fit">
                    <div>
                        <CreateLink :href="route('product_categories.create')"/>
                    </div>
                    <Delete
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap py-4 px-2">
                                <div class="gap-1 justify-center overflow-hidden flex items-center">
                                    <ViewLink
                                        :href="route('product_categories.show', { product_category: category.id })"
