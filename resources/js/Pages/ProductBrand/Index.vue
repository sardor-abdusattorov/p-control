...
import DeleteBulk from "@/Pages/ProductBrand/DeleteBulk.vue";
...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("product_brands.index"), params, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
...
const selectAll = (event) => {
    if (event.target.checked === false) {
        ...
        props.brands.data.forEach((brand) => {
            data.selectedId.push(brand.id);
        });
    }
};

const select = () => {
    data.multipleSelect = props.brand.data.length === data.selectedId.length;
};
        ...
        <div class="space-y-4">
            <div class="px-4 sm:px-0">
                <div class="rounded-lg overflow-hidden w-fit">
                    <div>
                        <CreateLink :href="route('product_brands.create')"/>
                    </div>
                    <Delete
                ...
                <div class="overflow-x-auto scrollbar-table">
                    <table class="w-full">
                        ...
                        <tr class="dark:bg-slate-900/50 text-left">
                            ...
                            <th class="px-2 py-4">{{ lang().label.image }}</th>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap py-4 px-2 sm:py-3">
                                {{ (props.brands.current_page - 1) * props.brands.per_page + index + 1 }}
                            </td>
                            ...
                            <td class="whitespace-nowrap py-4 px-2">
                                <div class="gap-1 justify-center overflow-hidden flex items-center">
                                    <ViewLink
                                        :href="route('product_brands.show', { product_brand: brand.id })"
